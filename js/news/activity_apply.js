...
//		alert(JSON.stringify(data))
		common.postApi("AddMessage", data, function(response) {
	...
	var success = function(response) {
			...
			if (array[0] == '0') {
				var template = '<img src="' +ApiUrl + "images/upload/temp/"+ array[1] + '" data-preview-src="' + array[1] + '" data-preview-group="1"/><input type="hidden" name="optionImages" value="' + array[1] + '" />';
