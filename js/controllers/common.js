...
//			}
		...
		common.initshowButton = function() {
				plus.webview.getWebviewById('view/nav/message.html').evalJS('showButton();');
			}
			//初始化通讯录信息
		common.initAddList = function() {
			plus.webview.getWebviewById('view/addList/addList_all_list.html').evalJS('GetUserList();');
		}

		//初始化我的信息
		common.initMine = function() {
			plus.webview.getWebviewById('view/nav/mine.html').evalJS('getuser();');
		}
